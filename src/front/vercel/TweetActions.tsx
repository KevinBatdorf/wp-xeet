...
import { type EnrichedTweet, formatNumber } from 'react-tweet';
import { TweetActionsCopy } from './TweetActionsCopy';
	...
	return (
		<div className={s.actions}>
			<a
				...
				aria-label={sprintf(
					__('Like. This Tweet has %s likes', 'xeet-wp'),
					favoriteCount,
				)}
			>
			...
			<a
				...
				target="_blank"
				rel="noopener noreferrer"
				aria-label={__('Reply to this Tweet on Twitter', 'xeet-wp')}
			>
				...
				<span className={s.replyText}>{__('Reply')}</span>
			</a>
